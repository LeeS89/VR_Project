...
public class MoveCube : MonoBehaviour
{
    ...
    [SerializeField] private GameObject targetDeflect;
    ...
    private void Awake()
    {
        //targetDeflect = GameObject.FindGameObjectWithTag("Drone");
        targetDeflect = GameObject.Find("BulletGoal");
    ...
    void Start()
    {
        ...
        spawner = targetDeflect.GetComponent<AsteroidSpawner>();
    ...
    void FixedUpdate()
    {
        ...
        if (_deflect)
        {
           /* goalPosition = _bulletSpawn.transform.position;
            ...
            transform.position = targetDeflect.transform.position;
    ...
    private void SetMovementVector()
    {
        ...
        //_points = new Vector3[] { transform.position, _shootPosition };
        movementVector = (_shootPosition - transform.position).normalized * (speed * 6);
    }
